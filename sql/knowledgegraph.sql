...
INSERT INTO `content` VALUES (1,4,'sed','http://man.linuxde.net/sed'),(3,7,'eclipse','https://www.eclipse.org/downloads/'),(4,7,'phpstorm','https://www.jetbrains.com/phpstorm/'),(5,5,'mysql official website','https://www.mysql.com/'),(6,6,'php official website','http://jp2.php.net/'),(7,8,' json online format','https://www.bejson.com/'),(8,21,'apache website','http://apache.org/'),(9,4,'awk','http://www.runoob.com/linux/linux-comm-awk.html'),(17,7,'emacs','http://www.gnu.org/software/emacs/'),(18,22,'Intellij Idea','https://www.jetbrains.com/idea/'),(19,4,'vim','https://www.vim.org'),(20,17,'关于 Laravel China','https://laravel-china.org/about'),(23,54,'jdk config (runoob)','http://www.runoob.com/java/java-environment-setup.html'),(24,11,'sdlka','https://www.starbucks.com.cn/'),(26,62,'sdfasfadfsf','https://show.metinfo.cn/muban/ps01301/263/'),(27,68,'C# 文件的输入与输出','http://www.runoob.com/csharp/csharp-file-io.html');
...
CREATE TABLE `link` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COMMENT='nodes link';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `structure` VALUES (1,'PHP','PHP是一种通用开源脚本语言，语法吸收了C、Java和Perl的特点，利于学习，使用广泛，主要适用于Web开发领域。它支持几乎所有流行的数'),(5,'Java','Java 教程 Java 是由Sun Microsystems公司于1995年5月推出的高级程序设计语言。 Java可运行于多个平台,如Windows, Mac OS,及其他多种UNIX版本的系统。'),(6,'过把瘾',''),(7,'Powerbuilder','Powerbuilder为什么会没落？现在有那种工具可以替代PB做数据库开发？'),(8,'C#','C# 是一个简单的、现代的、通用的、面向对象的编程语言，它是由微软（Microsoft）开发的。'),(9,'test','11111'),(10,'m12341324','12341324'),(11,'asdfasdfasdf','xxxxx'),(12,'xxxxxxxxxxx','asdfasdads'),(13,'basdfadsf','12341234');
...
-- Dump completed on 2018-05-06 17:05:19
