...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `knowledgegraph` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `content` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1 COMMENT='结点下面对应的知识内容';
...
INSERT INTO `content` VALUES (1,4,'sed','http://man.linuxde.net/sed'),(2,3,'LAMP极客学院','http://wiki.jikexueyuan.com/project/linux/lamp.html'),(3,7,'eclipse','https://www.eclipse.org/downloads/'),(4,7,'phpstorm','https://www.jetbrains.com/phpstorm/'),(5,5,'mysql official website','https://www.mysql.com/'),(6,6,'php official website','http://jp2.php.net/'),(7,8,' json online format','https://www.bejson.com/'),(8,21,'apache website','http://apache.org/'),(9,4,'awk','http://www.runoob.com/linux/linux-comm-awk.html'),(11,4,'vim','http://www.vim.org'),(17,7,'emacs','http://www.gnu.org/software/emacs/'),(18,22,'Intellij Idea','https://www.jetbrains.com/idea/');
...
INSERT INTO `structure` VALUES (1,'PHP'),(2,'Java'),(3,'require.js'),(4,'vue.js');
...
-- Dump completed on 2018-04-01  0:28:47
